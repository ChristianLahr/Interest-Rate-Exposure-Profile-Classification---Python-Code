...
# test_length = 250
test_length = int(len(X_data_all_rand) * 0.4) # ...% test data
...
# resultsLoop = np.array([[0,0]])
for kernal in range(1,2):
...
#        resultsLoop = np.append(resultsLoop,[[TestAtEnd,OtherTest]], axis = 0)
#        print('result: ', kernal, ' saved')
...
resultsLoop = np.append(resultsLoop,[[0,0]], axis = 0)
