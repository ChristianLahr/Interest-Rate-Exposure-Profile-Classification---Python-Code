...
def Model():
    ...
    return init, optimizer, cost, accuracy, x, y, weights, savedWeights, biases, savedBiases, keep_prob, pred, correct_pred
...
init, optimizer, cost, accuracy, x, y, weights, savedWeights, biases, savedBiases, keep_prob, pred, correct_pred = Model()
...
with tf.Session() as sess:
    ...
    batch_x, batch_y = next_batch(reader, 50000, n_classes, False)
